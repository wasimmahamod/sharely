...
let handleEditProfile=(item)=>{
  ...
  return (
    ...
    <>
      ...
      {coverModalShow &&
        <div className='lg:w-full lg:h-screen bg-[rgba(0,0,0,.4)] absolute top-[40%] left-0 z-50 lg:flex justify-center items-center'>
      ...
      {editProfile&&
      <div className='lg:w-full lg:h-screen absolute top-[25%] left-0 bg-primary z-20 lg:flex justify-center items-center'>
